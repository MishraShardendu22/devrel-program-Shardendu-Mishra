    ...
    <section id="about" className="relative pt-32 pb-20 md:pt-40 md:pb-24 overflow-hidden" ref={sectionRef}>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        <div className="text-center pb-12 md:pb-16">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tighter mb-6 text-(--secondary-300) dark:text-primary">
        ...
        <div className="pt-12 md:pt-16">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-12 text-(--secondary-300) dark:text-primary">
